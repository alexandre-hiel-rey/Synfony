...
return [
    ...
    [ // $dynamicRoutes
        ...
        285 => [[['_route' => 'app_welcome_index_gender', 'gender' => 'h', '_controller' => 'App\\Controller\\WelcomeController::indexCustom'], ['name', 'gender'], ['GET' => 0], null, false, true, null]],
        293 => [
            [['_route' => 'app_welcome_index_basic', '_controller' => 'App\\Controller\\WelcomeController::indexBasic'], ['name'], ['GET' => 0], null, false, true, null],
